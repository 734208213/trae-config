...
* 添加 snippets 功能 [详情查看](https://github.com/wx-minapp/minapp-vscode/blob/HEAD/README.md#snippets)
...
* 模板文件中 js 变量高亮（纯 wxml 文件才支持，vue 文件不支持），[详情查看](https://github.com/wx-minapp/minapp-vscode/blob/HEAD/README.md#highlight)
